...
@section('content')
    <div class="row">
        <div class="col-md">
            <div class="card mt-3">
                <div class="card-header">@lang('people.person')
                    <a href="{{ route('library.lending.persons') }}" class="pull-right">@lang('app.list')</a>
                </div>
        ...
        <div class="col-md">
            <div class="card mt-3">
                <div class="card-header">@lang('library.book')
                    <a href="{{ route('library.lending.books') }}" class="pull-right">@lang('app.list')</a>
                </div>
                <div class="card-body pb-2">
