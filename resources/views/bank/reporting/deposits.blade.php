...
@section('content')
    ...
    <div id="app" class="mb-3">
        ...
        <line-chart
            title="@lang('coupons.coupons_returned_per_day')"
            ylabel="# @lang('coupons.coupons')"
        ...
        @if( ! $projects->isEmpty() )
            ...
            @foreach ($projects as $project)
                <bar-chart title="@lang('coupons.coupons_returned_per_day_from_project', [ 'project' => $project->name ])"
                    ylabel="# @lang('coupons.coupons')"
