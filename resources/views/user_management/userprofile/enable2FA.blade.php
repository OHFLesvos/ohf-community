...
@section('content')
    ...
    a second factor is still required to login successfully into this application.')</p>
                <p>@lang('A mobile app is required to generate the Two-Factor code. Such apps can be found in the app store of your mobile device. We recommend
    ...
    <a target="_blank" href="https://play.google.com/store/apps/details?id=org.fedorahosted.freeotp">FreeOTP Authenticator</a>.')</p>
                <p>@lang('Scan the QR code with your authenticator app (e.g. "Google-Authenticator") and enter the numeric code into the field below.')</p>
            </div>
