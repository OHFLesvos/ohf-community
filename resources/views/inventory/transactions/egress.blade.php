    ...
    {!! Form::open(['route' => ['inventory.transactions.storeEgress', $storage ]]) !!}
        ...
        <template id="new-item-template">
            <div class="form-row">
                ...
                <div class="col">
                    {{ Form::bsText('item[]', null, [ 'list' => 'items' ], __('inventory.item')) }}
                </div>
                <div class="col-auto">
        ...
        <p><button type="button" class="btn btn-secondary add-new-item">@icon(plus-circle) @lang('inventory.remove_another_item')</button></p>
        <div class="form-row">
            <div class="col-sm">
