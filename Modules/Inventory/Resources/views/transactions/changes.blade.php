...
@section('title', __('inventory::inventory.transactions'))

@section('content')

    <h4 class="mb-3">@lang('inventory::inventory.changes_of_stock_in_storage', ['item' => request()->item, 'storage' => $storage->name ])</h4>
            ...
            <table class="table table-sm table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>@lang('inventory::inventory.origin') / @lang('inventory::inventory.destination')</th>
                        <th class="d-none d-sm-table-cell">@lang('inventory::inventory.sponsor')</th>
                    ...
                    @foreach($transactions as $transaction)
                        <tr>
                            ...
                            <td class="fit text-right">
                                @php
                                    echo Modules\Inventory\Entities\InventoryItemTransaction
    ...
    @else
        @component('components.alert.info')
            @lang('inventory::inventory.no_items_found')
        @endcomponent
    @endif
