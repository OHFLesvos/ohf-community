...
use Modules\UserManagement\Http\Requests\StoreUserProfile;
use Modules\UserManagement\Http\Requests\StoreNewUserPassword;
use Modules\UserManagement\Http\Requests\Store2FA;
...
class UserProfileController extends Controller
{
    ...
    public function delete()
    {
        ...
        return view('usermanagement::userprofile.deleted');
    }
    ...
    public function view2FA(Request $request)
    {
        ...
        if ($user->tfa_secret == null) {
            ...
            $qrCode->setSize(400);
            return view('usermanagement::userprofile.enable2FA', [
                'image' => base64_encode($qrCode->writeString()),
            ]);
        } else {
            return view('usermanagement::userprofile.disable2FA');
        }
    }
