...
@section('title', __('fundraising::fundraising.edit_donor'))
...
@section('content')
    ...
    {!! Form::model($donor, ['route' => ['fundraising.donors.update', $donor], 'method' => 'put']) !!}
       ...
       <div class="form-row">
            <div class="col-md">
                {{ Form::bsText('salutation', null, [ 'rel' => 'autocomplete', 'data-autocomplete-source' => json_encode(Modules\Fundraising\Entities\Donor::salutations()) ], __('app.salutation')) }}
            </div>
            <div class="col-md">
        ...
        <div class="form-row">
            ...
            <div class="col-md">
                {{ Form::bsText('language', null, [ 'rel' => 'autocomplete', 'data-autocomplete-source' => json_encode(Modules\Fundraising\Entities\Donor::languages()) ], __('app.correspondence_language')) }}
            </div>
        </div>
        <div class="form-row">
            <div class="col-md">
            ...
            <div class="col-md">
                {{ Form::bsTags('tags', $donor->tagsSorted->pluck('name'), [ 'data-suggestions' => json_encode($tag_suggestions) ], __('app.tags')) }}
            </div>
        </div>
