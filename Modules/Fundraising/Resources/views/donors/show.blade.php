...
@section('title', __('fundraising::fundraising.show_donor'))
                        ...
                        {!! Form::open(['route' => ['fundraising.donations.store', $donor ]]) !!}
                            <div class="form-row">
                                ...
                                <div class="col-md" id="exchange_rate_container">
                                    {{ Form::bsNumber('exchange_rate', null, [ 'placeholder' => __('fundraising::fundraising.optional_exchange_rate'), 'step' => 'any', 'title' => __('fundraising::fundraising.leave_empty_for_automatic_calculation') ], '') }}
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md">
                                    {{ Form::bsText('channel', null, [ 'required', 'placeholder' => __('fundraising::fundraising.channel'), 'rel' => 'autocomplete', 'data-autocomplete-source' => json_encode(array_values($channels)) ], '') }}
                                </div>
                                <div class="col-md">
                                    {{ Form::bsText('purpose', null, [ 'placeholder' => __('fundraising::fundraising.purpose') ], '') }}
                                </div>
                                <div class="col-md">
                                    {{ Form::bsText('reference', null, [ 'placeholder' => __('fundraising::fundraising.reference') ], '') }}
                                </div>
                            </div>
                            {{ Form::bsText('in_name_of', null, [ 'placeholder' => __('fundraising::fundraising.in_name_of') . ' ...' ], '') }}
                            <p>
