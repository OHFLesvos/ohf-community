...
@section('title', __('fundraising::fundraising.create_donor'))
...
@section('content')
    ...
    {!! Form::open(['route' => ['fundraising.donors.store']]) !!}
        ...
        <div class="form-row">
            <div class="col-md">
                {{ Form::bsText('salutation', null, [ 'autofocus', 'rel' => 'autocomplete', 'data-autocomplete-source' => json_encode(Modules\Fundraising\Entities\Donor::salutations()) ], __('app.salutation')) }}
            </div>
            <div class="col-md">
