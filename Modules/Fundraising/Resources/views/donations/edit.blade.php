...
@section('title', __('fundraising::fundraising.edit_donation_of', [ 'name' => $donor->full_name ]))
    ...
    {!! Form::model($donation, ['route' => ['fundraising.donations.update', $donor, $donation], 'method' => 'put']) !!}
        <div class="form-row">
            ...
            <div class="col-md-auto">
                {{ Form::bsSelect('currency', $currencies, null, [ 'required', 'id' => 'currency' ], __('fundraising::fundraising.currency')) }}
            </div>
            <div class="col-md">
        ...
        {{ Form::bsText('in_name_of', null, [ ], __('fundraising::fundraising.in_name_of')) }}
        <p>{{ Form::bsCheckbox('thanked', null, null, __('fundraising::fundraising.donor_thanked')) }}</p>
