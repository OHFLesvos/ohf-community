...
use Modules\Collaboration\Http\Requests\StoreArticle;
...
class ArticleController extends Controller
{
    ...
    public function store(StoreArticle $request) {
        ...
        return redirect()->route('kb.articles.show', $article)
            ->with('info', __('collaboration::wiki.article_created'));
    }
    ...
    public function update(WikiArticle $article, StoreArticle $request) {
        ...
        return redirect()->route('kb.articles.show', $article)
            ->with('info', __('collaboration::wiki.article_updated'));
    }
    ...
    public function destroy(WikiArticle $article) {
        ...
        return redirect()->route('kb.index')
            ->with('info', __('collaboration::wiki.article_deleted'));
    }
