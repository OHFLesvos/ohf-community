...
@section('title', __('collaboration::kb.knowledge_base'))
...
@section('content')
    ...
    @if (isset($search))
        @if( ! $article_results->isEmpty() )
            ...
            <p><small>@lang('collaboration::wiki.found_num_articles_containing_word', ['num' => $article_results->total(), 'word' => $search ])</small></p>
        ...
        <div class="row">
                    ...
                    @unless($featured_articles->isEmpty())
                        <div class="card mb-3">
                            <div class="card-header">
                                @lang('collaboration::wiki.featured_articles')
                            ...
                            @else
                                <div class="card-body p-3">
                                    <em>@lang('collaboration::wiki.no_articles_found')</em>
                                </div>
                            @endunless
                        </div>
                    @endunless
            ...
            @unless($popular_articles->isEmpty())
                <div class="col-sm mb-3">
                    <div class="card">
                        <div class="card-header">
                            @lang('collaboration::wiki.popular_articles')
            ...
            @unless($recent_articles->isEmpty())
                <div class="col-sm mb-3">
                    <div class="card">
                        <div class="card-header">
                            @lang('collaboration::wiki.recenlty_update_articles')
