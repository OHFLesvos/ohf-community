...
@section('title', __('collaboration::calendar.calendar'))
...
@section('script')
    ...
    var createEventAllowed = @can('create', Modules\Collaboration\Entities\CalendarEvent::class) true @else false @endcan;
    var manageResourcesAllowed = @can('create', Modules\Collaboration\Entities\CalendarResource::class) true @else false @endcan;
