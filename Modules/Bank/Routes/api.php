...
Route::group(['middleware' => ['language', 'auth']], function () {
    Route::group(['middleware' => ['can:do-bank-withdrawals']], function () {
        Route::get('bank/withdrawal/dailyStats', 'API\BankController@dailyStats')->name('api.bank.withdrawal.dailyStats');
        Route::get('bank/withdrawal/search', 'API\BankController@search')->name('api.bank.withdrawal.search');
