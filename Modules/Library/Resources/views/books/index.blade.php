...
@section('wrapped-content')
    ...
    @if($books->count() > 0)
            ...
            <table class="table table-sm table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('library::library.author')</th>
                        <th class="d-none d-sm-table-cell">@lang('library::library.isbn')</th>
        ...
        {{ $books->links() }}
        <p><small>@lang('library::library.num_books_in_total', [ 'books' => $num_books ])</small></p>
    @else
        @component('components.alert.info')
            @lang('library::library.no_books_registered')
        @endcomponent
    @endif
