...
class GlobalSummaryController extends Controller
{
    ...
    private static function revenueByRelationField(string $idField, string $relationField, ?Carbon $dateFrom = null, ?Carbon $dateTo = null, ?User $user = null, ?array $filters = []): Collection
    {
