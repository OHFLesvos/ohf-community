...
class Budget extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "agreed_amount_formatted" => $this->formatCurrency($this->agreed_amount, $this->currency),
            "initial_amount" => (float) $this->initial_amount,
            "initial_amount_formatted" =>  $this->formatCurrency($this->initial_amount, $this->currency),
            'currency' => $this->currency,
            "donor_id" => $this->donor_id,
            'donor' => new Donor($this->whenLoaded('donor')),
            'balance' => $balance,
            'balance_formatted' => $this->formatCurrency($balance, $this->currency),
