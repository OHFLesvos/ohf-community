...
pagination = __webpack_require__(247);
...
function writeRow(person) {
    ...
    if (bulk_select) {
        bulk_select_elem = $('<td>').append($('<input>').attr('type', 'checkbox').attr('name', 'selected_people[]').val(person.id).on('change', function () {
    ...
    return $('<tr>').attr('id', 'person-' + person.id).append(bulk_select_elem).append($('<td>').html(icon != '' ? '<i class="fa fa-' + icon + '"></i>' : '')).append($('<td>').append($('<a>').attr('href', 'people/' + person.id).text(person.family_name))).append($('<td>').append($('<a>').attr('href', 'people/' + person.id).text(person.name))).append($('<td>').text(person.date_of_birth)).append($('<td>').text(person.nationality)).append($('<td>').text(person.police_no)).append($('<td>').text(person.registration_no)).append($('<td>').text(person.section_card_no)).append($('<td>').text(person.languages ? Array.isArray(person.languages) ? person.languages.join(', ') : person.languages : '')).append($('<td>').text(person.remarks))
